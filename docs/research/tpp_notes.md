# Notes TPP (Temporal Point Process) — Piste explorée, non retenue

> Exploration de l'approche Temporal Point Process pour la cessation d'orages.
> Finalement non retenue au profit de XGBoost (meilleur AUC, plus simple).
